...
const analyzeResume = async (req, res) => {
    try {
        ...
        const truncated=resumeText.slice(0, 6000);
         const prompt = `
You are an elite Silicon Valley technical recruiter and career coach.
...
{
  "summary": "3-4 sentence highly detailed professional summary of the candidate, highlighting their core identity and standout achievements.",
  "experienceLevel": "Junior" | "Mid" | "Senior",
  "skillsDetected": ["skill1", "skill2", "skill3", ...],
  "strengths": ["strength1", "strength2", "strength3"],
  "areasForImprovement": ["weakness1", "weakness2"],
  "recommendedDomains": [
    {
      "label": "exact domain name from the available list",
      "reason": "a highly specific sentence explaining why this domain fits their experience perfectly",
      "confidence": 85
    }
  ]
}
...
- skillsDetected: list up to 15 actual technical skills/frameworks found
- strengths: list 3 specific professional strengths with brief context from their resume
- areasForImprovement: list 2 constructive areas where their resume or experience could be improved (e.g., missing metrics, lack of cloud experience)
